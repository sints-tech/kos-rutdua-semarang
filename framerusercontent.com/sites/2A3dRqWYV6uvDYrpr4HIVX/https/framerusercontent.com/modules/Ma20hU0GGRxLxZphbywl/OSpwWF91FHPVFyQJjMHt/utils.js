...
export function getIconSelection(iconKeys, selectByList, iconSearch = "", iconSelection, lowercaseIconKeyPairs) { // gotta get the exact match first THEN find
...
export function useIconSelection(iconKeys, selectByList, iconSearch = "", iconSelection, lowercaseIconKeyPairs) { // Clean search term
