...
fontStore.loadFonts(["GF;Geist-600", "Inter-Bold", "Inter-BoldItalic", "Inter-Italic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
        family: "Geist",
