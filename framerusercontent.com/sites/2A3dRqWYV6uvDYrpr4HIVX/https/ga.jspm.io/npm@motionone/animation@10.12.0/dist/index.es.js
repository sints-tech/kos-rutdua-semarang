...
class Animation {
    constructor(n, r = [0, 1], {
        ...
        this.tick = t => {
            ...
            u = u;
            let e = 0;
            e = void 0 !== this.pauseTime ? this.pauseTime : (t - this.startTime) * this.rate;
            this.t = e;
            e /= 1e3;
            e = Math.max(e - u, 0);
            "finished" === this.playState && void 0 === this.pauseTime && (e = this.totalDuration);
            ...
            1 === r && a--;
            const o = a % 2;
            ("reverse" === p || "alternate" === p && o || "alternate-reverse" === p && !o) && (r = 1 - r);
            const h = e >= this.totalDuration ? 1 : Math.min(r, 1);
            const m = d(this.easing(h));
            n(m);
            const c = void 0 === this.pauseTime && ("finished" === this.playState || e >= this.totalDuration + l);
            if (c) {
                this.playState = "finished";
                null === (i = this.resolve) || void 0 === i ? void 0 : i.call(this, m)
            } else "idle" !== this.playState && (this.frameRequestId = requestAnimationFrame(this.tick))
        };
        this.play()
    }
    play() {
