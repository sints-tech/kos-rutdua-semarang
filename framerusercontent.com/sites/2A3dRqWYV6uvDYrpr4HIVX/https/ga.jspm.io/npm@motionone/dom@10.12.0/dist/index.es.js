...
const testAnimation = e => document.createElement("div").animate(e, {
    duration: .001
});
const C = {
...
function animateStyle(e, t, n, o = {}) {
    ...
    return () => {
        const readInitialValue = () => {
            var t, n;
            return null !== (n = null !== (t = H.get(e, x)) && void 0 !== t ? t : null === z || void 0 === z ? void 0 : z.initialValue) && void 0 !== n ? n : 0
        };
        ...
        isCssVar(x) && (R.cssRegisterProperty() ? registerCssVariable(x) : A = false);
        if (A) {
            z && (i = i.map((e => r(e) ? z.toDefaultUnit(e) : e)));
            1 !== i.length || R.partialKeyframes() && !u || i.unshift(readInitialValue());
            const t = {
                delay: a.ms(m),
                duration: a.ms(g),
                endDelay: a.ms(h),
            ...
            d = e.animate({
                [x]: i,
                offset: E,
                easing: c(v) ? v.map(convertEasing) : void 0
            }, t);
            d.finished || (d.finished = new Promise(((e, t) => {
                d.onfinish = e;
                d.oncancel = t
            })));
            ...
            d = new w(render, i, Object.assign(Object.assign({}, o), {
                duration: g,
                easing: v
            }))
        } else {
...
function resolveElements(e, t) {
    ...
    if ("string" === typeof e)
        if (t) {
            null !== (n = t[e]) && void 0 !== n ? n : t[e] = document.querySelectorAll(e);
            e = t[e]
...
const withControls = (e, t, n = i.duration) => new Proxy({
...
const I = {
    get: (e, t) => {
        ...
        switch (t) {
            ...
            case "finished":
                e.finished || (e.finished = Promise.all(e.animations.map(selectFinished)).catch(l));
                return e.finished;
            case "stop":
                return () => {
            ...
            default:
                return "undefined" === typeof(null === n || void 0 === n ? void 0 : n[t]) ? void 0 : () => e.animations.forEach((e => e[t]()))
        }
    },
    set: (e, t, n) => {
        switch (t) {
...
function calcNextTime(e, t, n, o) {
    var i;
    return r(t) ? t : t.startsWith("-") || t.startsWith("+") ? Math.max(0, e + parseFloat(t)) : "<" === t ? n : null !== (i = o.get(t)) && void 0 !== i ? i : e
}
...
function timeline(e, t = {}) {
    ...
    return withControls(i, t, null === (n = o[0]) || void 0 === n ? void 0 : n[3].duration)
}

function createAnimationsFromTimeline(e, t = {}) {
    var {
        defaultOptions: n = {}
    } = t, o = b(t, ["defaultOptions"]);
    const r = [];
    const a = new Map;
    const c = {};
    const l = new Map;
        ...
        for (let e = 0; e < E; e++) {
            ...
            for (const t in p) {
                ...
                if (s(f)) {
                    ...
                    S(2 === a.length || !e, "spring must be provided 2 keyframes within timeline");
    ...
    a.forEach(((e, t) => {
        for (const s in e) {
            ...
            r.push([t, s, c, Object.assign(Object.assign(Object.assign({}, n), {
                duration: d,
                easing: f,
                offset: l
            }), o)])
            ...
            createAnimation: (e, t, n, o, i) => {
                ...
                if (l) {
                    ...
                    if (d) {
                        ...
                        const o = (null === t || void 0 === t ? void 0 : t.startTime) || n || 0;
                        const r = (null === t || void 0 === t ? void 0 : t.currentTime) || performance.now() - o;
                        const a = d(r).current;
                        u = null !== (s = l) && void 0 !== s ? s : a;
                        (1 === c || 2 === c && null === e[0]) && (f = O((e => d(e).current), r, a))
                    } else u = null !== (r = l) && void 0 !== r ? r : parseFloat(t());
                    const g = getGenerator(u, n, f, null === o || void 0 === o ? void 0 : o.includes("scale"));
                    const m = getKeyframes(g);
                    a = Object.assign(Object.assign({}, m), {
                        easing: "linear"
                    });
                    if (i) {
                        i.generator = g;
...
function notifyTarget({
    ...
    var o;
    null === (o = q.get(e)) || void 0 === o ? void 0 : o.forEach((o => {
        o({
            target: e,
            contentSize: t,
            get size() {
...
function resizeElement(e, t) {
    ...
    return () => {
        n.forEach((e => {
            ...
            (null === n || void 0 === n ? void 0 : n.size) || (null === K || void 0 === K ? void 0 : K.unobserve(e))
        }))
    }
}
const G = new Set;
...
function scrubAnimation(e, n) {
    ...
    e.forEachNative(((e, {
        ...
        if (e.updateDuration) {
            ...
            n || (t.easing = "linear");
            null === (i = null === (o = e.effect) || void 0 === o ? void 0 : o.updateTiming) || void 0 === i ? void 0 : i.call(o, t)
        }
    }));
    return () => {
...
function createMotionState(e = {}, t) {
    ...
    const s = {};
    const r = {};
    for (const n of le) r[n] = "string" === typeof e[n] ? e[n] : null === t || void 0 === t ? void 0 : t.getContext()[n];
    ...
    function* animateUpdates() {
        ...
        for (const n of le) {
            ...
            if (s)
                for (const n in s)
                    if ("transition" !== n) {
                        f[n] = s[n];
                        r[n] = getOptions(null !== (o = null !== (t = s.transition) && void 0 !== t ? t : e.transition) && void 0 !== o ? o : {}, n)
                    }
        }
        ...
        Promise.all(d.map((e => e.finished))).then((() => {
...
export {
    Y as ScrollOffset, animate, animateStyle, createMotionState, createStyleString, createStyles, getAnimationData, getStyleName, F as glide, inView$1 as inView, fe as mountedStates, resize, scroll, N as spring, stagger, H as style, timeline, withControls
};
