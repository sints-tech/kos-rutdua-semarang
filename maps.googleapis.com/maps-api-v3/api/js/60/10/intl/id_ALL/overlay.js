google.maps.__gjsload__('overlay', function(_) {
    var lBa = function() {},
        ...
        oBa = function(a, b) {
            ...
            _.rm(d.Eg);
            b instanceof _.wk ? (_.Mk(b, "Ox"), _.Q(b, 148440)) : b instanceof _.dl && (_.Mk(b, "Oxs"), _.Q(b, 181451))
        },
        pBa = function(a) {
            const b =
                $D(a);
            ...
            b.Eg = null;
            b.Fg && (_.sm(b.Fg.Eg), b.Fg = null)
        },
        uBa = function(a) {
            if (a) {
                var b = a.getMap();
                if (qBa(a) !== b && b && b instanceof _.wk) {
                    const c = b.__gm;
                    c.overlayLayer ? a.__gmop = new rBa(b, a, c.overlayLayer) : c.Fg.then(({
                        Zg: d
                    }) => {
                        const e = new sBa(b, d);
                        d.Li(e);
    ...
    var rBa = class {
        ...
        sBa = class {
            ...
            Nh(a, b, c, d, e, f, g, h) {
                ...
                for (const n of this.Fg) vBa(n, l), n.draw()
            }
            uo(a) {
                this.Fg.push(a);
                this.Eg &&
    ...
    _.Fi("overlay", {
        hD: function(a) {
            if (a) {
                ...
                tBa(a);
                var b = a.getMap();
                b && (b instanceof _.wk ? uBa(a) : a && (b = a.getMap(), ($D(a).Jg || null) !== b && (b && oBa(a, b), $D(a).Jg = b)))
            }
        },
