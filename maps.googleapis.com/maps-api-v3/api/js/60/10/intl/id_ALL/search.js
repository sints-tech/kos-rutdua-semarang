    ...
    var Mxa = {
        ...
        Kxa = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.yc(_.Gl(new _.$l((this.sn.x * 256 + this.source.a[0]) / a, (this.sn.y * 256 + this.source.a[1]) / a))).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
                    ...
                    if (!Nxa.has(a)) {
                        ...
                        var c = [],
                            ...
                            e = () => {
                                ...
                                b.forEach(f => {
                                    if (f = f.data) c.push(_.Pj(f, "insert", g => {
                                        d(g, "addfeatures")
                                    })), c.push(_.Pj(f, "remove", g => {
                                        d(g, "removefeatures")
                                    }))
                                })
                            };
                        ...
                        f.length && _.bk(a, "addfeatures", f)
                    })()
                }
            }
        };
    sD.enableFeatureMapEventsRasterOnly = sD.enableFeatureMapEventsRasterOnly;
    _.Ik(sD.prototype, {
        map: _.Ep
    });
    _.ia.google.maps.search = {
        GoogleLayer: sD
    };
    _.Fi("search", {});
});