google.maps.__gjsload__('search', function(_) {
    var ura = function(a) {
        ...
        tra = function(a) {
            let b = _.jo,
                c = -1;
            a.tiles.forEach(e => {
                e.zoom > c && (b = e.si, c = e.zoom)
            });
            if (c === -1) return [];
            const d = [];
            a.jv().forEach(e => {
                e.a && e.a.length >= 2 && d.push(new vra(e, b, c))
            });
            return d
        },
        wra = class extends _.Xm {};
    var xra = {
            ["1"]: {}
        },
        vra = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.Pr(new _.Kq((this.zn.x * 256 + this.source.a[0]) / a, (this.zn.y * 256 + this.source.a[1]) / a)).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
                    ...
                    if (!yra.has(a)) {
                        ...
                        var c = [],
                            ...
                            e = () => {
                                ...
                                b.forEach(f => {
                                    if (f = f.data) c.push(_.Em(f, "insert", g => {
                                        d(g, "addfeatures")
                                    })), c.push(_.Em(f, "remove", g => {
                                        d(g, "removefeatures")
                                    }))
                                })
                            };
    ...
    GH.enableFeatureMapEventsRasterOnly = GH.enableFeatureMapEventsRasterOnly;
    _.An(GH.prototype, {
        map: _.Ht
    });
    _.na.google.maps.search = {
        GoogleLayer: GH
    };
    _.Uk("search", {});
});