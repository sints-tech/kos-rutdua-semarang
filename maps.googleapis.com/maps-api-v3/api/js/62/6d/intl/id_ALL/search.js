    ...
    var rra = function(a) {
        ...
        qra = function(a) {
            let b = _.bo,
                c = -1;
            a.tiles.forEach(e => {
                e.zoom > c && (b = e.wi, c = e.zoom)
            });
            if (c === -1) return [];
            const d = [];
            a.nv().forEach(e => {
                e.a && e.a.length >= 2 && d.push(new sra(e, b, c))
            });
            return d
        },
        tra = class extends _.Qm {};
    var ura = {
            ["1"]: {}
        },
        sra = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.Ir(new _.Cq((this.Cn.x * 256 + this.source.a[0]) / a, (this.Cn.y * 256 + this.source.a[1]) / a)).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
            ...
            getExtendedContent(a) {
                if (this.Fg === ura) try {
                    this.Fg = this.source.c ? JSON.parse(this.source.c) : {}
                } catch (b) {
                    this.Fg = {}
                }
                return this.Fg[a] ? ? {}
                    ...
                    if (!vra.has(a)) {
                        ...
                        var c = [],
                            ...
                            e = () => {
                                ...
                                b.forEach(f => {
                                    if (f = f.data) c.push(_.ym(f, "insert", g => {
                                        d(g, "addfeatures")
                                    })), c.push(_.ym(f, "remove", g => {
                                        d(g, "removefeatures")
                                    }))
                                })
                            };
                        ...
                        f.length && _.O(a, "addfeatures", f)
                    })()
                }
            }
        };
    QH.enableFeatureMapEventsRasterOnly = QH.enableFeatureMapEventsRasterOnly;
    _.tn(QH.prototype, {
        map: _.Gt
    });
