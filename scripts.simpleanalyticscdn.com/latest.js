...
! function(l, t, e, n, p) {
    try {
        ...
        if (At.sri = d, D && (At.mobile = D.mobile, At.brands = S(D.brands)), y.doctype || p("Add DOCTYPE html for accurate dimensions"), ft !== v && (At.hostname_original = v), !_t && c in g && "1" == g[c]) return p(b + c + " is enabled. See " + I + "/dnt"); - 1 != v.indexOf(".") && !/^[0-9.:]+$/.test(v) || ht || p("Set hostname on " + v + ". See " + I + "/overwrite-domain-name");
        var $t, jt, Dt = {},
